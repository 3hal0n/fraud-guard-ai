...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-navy-950">
      {/* Navigation is provided by the global Navbar component in layout */}
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="glass rounded-2xl p-8 hover:bg-navy-800/50 transition-all ring-1 ring-slate-700/60">
