...
export default function SignUpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Sign Up:", { fullName, email, password, plan: planParam || "free" });
  };
  ...
  return (
    <div className="min-h-screen bg-navy-950 flex items-center justify-center px-6 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-teal-600/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8">
          <div className="mb-6">
            ...
            <p className="text-slate-500">Start protecting your transactions today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                id="terms"
                type="checkbox"
                className="mt-1 w-4 h-4 rounded border-slate-700 bg-navy-900 text-teal-500 focus:ring-2 focus:ring-teal-500 focus:ring-offset-0"
                required
              />
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-teal-500 hover:bg-teal-600 text-navy-950 rounded-lg font-semibold transition-all shadow-lg shadow-teal-500/20 hover:shadow-teal-500/30"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-navy-800 text-slate-500">Or continue with</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full px-6 py-3 bg-navy-900 hover:bg-navy-800 border border-slate-700 text-foreground rounded-lg font-medium transition-all flex items-center justify-center gap-3"
            >
