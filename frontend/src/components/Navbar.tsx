        ...
        <div className="flex items-center gap-2 ml-auto md:ml-0">
          <SignedIn>
            <div className="hidden md:flex items-center gap-3">
              <Link
                href="/dashboard"
                className="px-4 py-2 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 text-white text-sm font-medium shadow-lg hover:scale-[1.02] transition-transform"
              >
                Dashboard
              </Link>
              <UserButton />
          ...
          <SignedOut>
            <div className="hidden md:flex items-center gap-3">
              <Link
                href="/login"
                className="px-4 py-2 text-white text-sm font-medium hover:text-slate-200 transition-colors"
              >
                Login
              </Link>
              <SignUpButton mode="modal">
                <span className="px-4 py-2 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 text-white text-sm font-medium shadow-lg hover:scale-[1.02] transition-transform cursor-pointer">
                  Get Started
                </span>
              </SignUpButton>
            </div>
          ...
          <nav className="flex flex-col gap-2 text-sm text-slate-200">
            ...
            <SignedOut>
              <Link
                onClick={() => setOpen(false)}
                href="/login"
                className="block px-3 py-2 rounded hover:bg-white/3 transition-colors"
              >
                Login
              </Link>
              <SignUpButton mode="modal">
                <span className="mt-2 flex items-center justify-center w-full px-4 py-2 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 text-white text-sm font-medium shadow cursor-pointer hover:scale-[1.02] transition-transform">
                  Get Started
                </span>
              </SignUpButton>
            </SignedOut>
