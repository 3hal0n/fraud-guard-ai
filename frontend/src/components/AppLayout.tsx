...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex font-sans text-white selection:bg-cyan-500/30">
      {/* Sidebar */}
      <aside className="w-64 bg-black border-r border-white/5 flex flex-col z-20">
        {/* Logo */}
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 ${
                  isActive
                    ? "bg-white/10 text-cyan-400 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]"
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        {/* Top Header */}
        <header className="bg-[#050505]/80 backdrop-blur-xl border-b border-white/5 px-8 py-4 z-10 sticky top-0">
        ...
        <main className="flex-1 overflow-auto p-8 relative">
          {/* Ambient background glow for inner pages */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-cyan-500/5 blur-[120px] rounded-full pointer-events-none z-0" />
